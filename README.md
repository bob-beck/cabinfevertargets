...
I have not yet hooked this up with a web front end to let a shooter just [generate targets](src). It's not hard, but I'll do that if and when I know it generates correct stuff, and the CFC decides it actually wants to use this method, which might not be this year.
